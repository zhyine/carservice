            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form:form id="inputForm" cssClass="form-horizontal" action="/content/category/save" method="post" modelAttribute="carContentCategory">
                            <form:hidden path="id" />
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input id="parentName" class="form-control required" placeholder="请选择" data-toggle="modal" data-target="#modal-default" />
